...
INSERT INTO event
    ...
    VALUES ('HACK EVERYBODY', 1, '1490805999363', '1490805999363',
        'cool, we can hack everybody', 1,
        'https://www.facebook.com/groups/410797219090898/',
        'someSupfdsafasdfdsferCoolID');

INSERT INTO event
    (title, all_day, start, end, description, creator, url, id)
    VALUES ('HACK EVERYBODY', 1, '1490805999363', '1490805999363',
        'cool, we can hack everybody', 1,
        'https://www.facebook.com/groups/410797219090898/', 'someSuperCoolID');
...
INSERT INTO job_post
    (creator, id, creation_time, title, content, web_link)
    VALUES (1, 'sasdddCgafgsfdgsdfhsfgasdfasdfsdaoolId', '1490805999363',
...
INSERT INTO bug_post
    (creator, id, creation_time, title, content, web_link)
    VALUES (1, 'sasdgsdafasdfasdfasdljkjklfddCoolId', '1490805999363',
        'hacking me and get money', 'money for bug',
			  'https://www.facebook.com/groups/410797219090898/');

INSERT INTO bug_post
    (creator, id, creation_time, title, content, web_link)
    VALUES (1, 'sasdddasdfasdfasdkjhlkjlhlgafdgdfghfgdhCoolId',
        '1490805999363', 'pentest this server',
			  'i give you 100000000000$ for that',
			  'https://www.facebook.com/groups/410797219090898/');

INSERT INTO bug_post
    (creator, id, creation_time, title, content, web_link)
    VALUES (1, 'sasdddCfghjjkghfghjkhjkkjkhjoolId', '1490805999363',
